                ...
                <div className="card-body">
                    ...
                    <section className="mb-4">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <strong>Salário:</strong> <br /> {funcionario?.salario ? `R$ ${funcionario.salario}` : "Não informado"}
                            </div>
                            <div className="col-md-6 mb-3">
                    ...
                    <section className="mb-4">
                        ...
                        <hr />
                        <span className={`badge px-3 py-2 ${funcionario?.status ? 'bg-success' : 'bg-danger'}`}>
